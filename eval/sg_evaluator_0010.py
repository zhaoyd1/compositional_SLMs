...
from eval.evaluate_lm import (R2D2GenEvaluator, R2D2GenFastEvaluator,
                              VanillaGPTEvaluator)
from utils.beam_searcher_0011 import R2D2GenFastBeamSearcher
...
class Scorer():
    ...
    def score(self, input_ids, tags):
        ...
        for i in range(1):
            ...
            elif self.model_type == "n-ary-gen":
                with torch.no_grad():
        ...
        with open("sg_result/eff_0011.txt", 'a') as file:
            file.write("model_0011_" + str(beam_size) + "\n")
