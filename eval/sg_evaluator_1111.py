...
from eval.evaluate_lm import (R2D2GenEvaluator, R2D2GenFastEvaluator,
                              VanillaGPTEvaluator)
from utils.beam_searcher_tg_seq import R2D2GenFastBeamSearcher
...
class Scorer():
    ...
    def score(self, input_ids, tags):
        ...
        with open("sg_result/eff_tg_seqbeam_searcher_tg_seq.txt", 'a') as file:
            file.write("model_tg_seqbeam_searcher_tg_seq_" + str(beam_size) + "\n")
