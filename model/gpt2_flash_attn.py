...
class GPT2Model(GPT2PreTrainedModel):
    def __init__(self, config, no_embedding=False, no_extra_embedding=False, no_layer_norm=False):
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        tg_inference: Optional[bool] = None
        ...
        if labels is not None:
            ...
            if tg_inference:
                loss = loss.reshape(shift_labels.size(0), shift_labels.size(1)).sum(-1)
