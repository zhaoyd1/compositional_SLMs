...
base_path=save/dial_tg_seq_5

for i in $(seq $start $end)
do
  pretrain_path="${base_path}/model${i}.bin"
  CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nnodes=1 --nproc_per_node=1 trainer/dial_trainer_eval_tg_seq.py \
    --model_type tg \
    ...
    --output_dir save/dial_tg_seq_eval_01234 \
