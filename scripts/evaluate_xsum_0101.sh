...
base_path=save/xsum_0101_15

for i in $(seq $start $end)
do
  pretrain_path="${base_path}/model${i}.bin"
  CUDA_VISIBLE_DEVICES=5 torchrun --standalone --nnodes=1 --nproc_per_node=1 trainer/xsum_trainer_eval_0101.py \
    --model_type tg \
    ...
    --output_dir save/xsum_0101_eval_15 \
