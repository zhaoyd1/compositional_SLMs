...
base_path=save/xsum_0110_15

for i in $(seq $start $end)
do
  pretrain_path="${base_path}/model${i}.bin"
  CUDA_VISIBLE_DEVICES=2 torchrun --standalone --nnodes=1 --nproc_per_node=1 trainer/xsum_trainer_eval_0110.py \
    --model_type tg \
    ...
    --output_dir save/xsum_0110_eval_15 \
