...
base_path=save/xsum_1111_15

for i in $(seq $start $end)
do
  pretrain_path="${base_path}/model${i}.bin"
  CUDA_VISIBLE_DEVICES=5 torchrun --standalone --nnodes=1 --nproc_per_node=1 trainer/xsum_trainer_eval_1111.py \
    --model_type tg \
    ...
    --output_dir save/xsum_1111_eval_15_succ5 \
