...
base_path=save/xsum_gpt2_15

for i in $(seq $start $end)
do
  pretrain_path="${base_path}/model${i}.bin"
  CUDA_VISIBLE_DEVICES=5 torchrun --standalone --nnodes=1 --nproc_per_node=1 trainer/xsum_trainer_eval_gpt2.py \
    --model_type gpt \
    ...
    --output_dir save/xsum_gpt2_eval_15 \
