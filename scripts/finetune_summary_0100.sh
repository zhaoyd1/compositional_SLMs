...
CUDA_VISIBLE_DEVICES=2,3,4,5 torchrun --standalone --nnodes=1 --nproc_per_node=4 trainer/xsum_trainer_0100.py \
    --model_type tg \
    ...
    --output_dir save/xsum_0100_15 \
    --pretrain_dir save/0100_1/ \
    --log_step 20 \
