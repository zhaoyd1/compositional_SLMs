...
CUDA_VISIBLE_DEVICES=4,5 torchrun --standalone --nnodes=1 --nproc_per_node=2 trainer/xsum_trainer_1100.py \
    --model_type tg \
    ...
    --output_dir save/xsum_1100_15 \
    --pretrain_dir save/1100_1/ \
    --log_step 20 \
