...
CUDA_VISIBLE_DEVICES=6,7 torchrun --standalone --nnodes=1 --nproc_per_node=2 trainer/xsum_trainer_1101.py \
    --model_type tg \
    ...
    --output_dir save/xsum_1101_15 \
    --pretrain_dir save/1101_1/ \
    --log_step 20 \
