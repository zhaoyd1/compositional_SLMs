...
#     --raw_corpus_path corpus/bllip/train_LG_nonlabel_doc_new.cc \
#     --output_path corpus/tg_nonlabel_train.lazy \
#     --special_label 1

python utils/dataset_builder.py \
    --mode bllip_1010 \
    --tokenizer_config_path data/gpt2-small \
    --raw_corpus_path corpus/bllip/1010_train_doc.txt \
    --data_raw_path corpus/bllip/bllip_train.raw \
    --output_path corpus/1010_train.lazy \
    --special_label 1
