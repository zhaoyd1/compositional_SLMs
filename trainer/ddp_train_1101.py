...
from reader.dataset_1101 import GPT2Dataset
from torch.utils.data.distributed import DistributedSampler
...
from masking_1101 import utils as masking_utils
from masking_1101 import masking_types as types
...
if __name__ == '__main__':
    ...
    if args.tg_enabled == 1 and args.eval_mode == 0:
        ...
        trainer.evaluate_tg_doc('corpus/bllip/bllip_test.raw', 'corpus/bllip/1000_eval_topks.txt', ranges, mask_rules)
