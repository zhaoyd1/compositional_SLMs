...
from reader.dataset_1110 import GPT2Dataset
from torch.utils.data.distributed import DistributedSampler
...
from masking_1110 import utils as masking_utils
from masking_1110 import masking_types as types
...
if __name__ == '__main__':
    ...
    if args.tg_enabled == 1:
        collator_fn = collator.generative_r2d2_collate_fn_tg
    else:
    ...
    def process_seq(seq, seq_len):
        ...
        return src_p, tgt_p, mask, relpos
