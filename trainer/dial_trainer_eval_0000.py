...
from reader.dataset_dialog_0000 import XSumDataset
...
from utils.beam_searcher_0000_gen import R2D2GenFastBeamSearcher
...
if __name__ == '__main__':
    ...
    cmd.add_argument('--tg_enabled', default=0, type=int, help="enable tg")
    ...
    if is_master and args.eval_perepoch:
        ...
        eval_collator_fn = XSumCollator("test", padding=-1).generative_r2d2_xsum_collate_fn
