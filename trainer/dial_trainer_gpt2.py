...
from reader.dataset_dialog import XSumDataset
...
if __name__ == '__main__':
    ...
    collator_fn = collator.xsum_collator_fn_gpt2
    ...
    if is_master and args.eval_perepoch:
        ...
        eval_collator_fn = XSumCollator("test", not args.disable_group, \
                               external_vocab_path=args.ext_vocab_path, padding=-1).xsum_collator_fn_gpt2
