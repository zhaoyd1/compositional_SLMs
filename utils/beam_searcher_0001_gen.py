...
from model.stack_state_0001_gen import ActionType, Node, State, BeamContext
import numpy as np
import torch
    ...
    def beam_search(self, 
        ...
        if chunk_input_ids is not None:
            outputs = self.model(chunk_input_ids=chunk_input_ids, 
                                 ...
                                 chunk_attn_masks=chunk_attn_masks,
                                 masks=masks,
                                 span_ids=None,
            ...
            action_len_bucket, token_len_bucket = beam_context.init_history_kv(past_action_kvs, chunk_attn_masks, seq_lens, group_ids)
